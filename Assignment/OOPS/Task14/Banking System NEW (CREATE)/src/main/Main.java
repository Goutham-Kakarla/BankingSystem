...
import dao.IBankServiceProvider;
...
public class Main {
	...
	private static void createAccountMenu(IBankServiceProvider bankServiceProvider, Scanner scanner) throws SQLException {
       ...
       // break;
        ...
        Customer customer = new Customer(customer_id, first_name, last_name, email, phone_number, address, dateStr);
        ...
        switch (accountTypeChoice) {
            case 1:
                bankServiceProvider.createAccount( Account.generateAccount_id(),customer, "Savings", initialBalance);
                break;
            case 2:
                bankServiceProvider.createAccount(Account.generateAccount_id(),customer,  "Current", initialBalance);
                break;
            case 3:
                bankServiceProvider.createAccount( Account.generateAccount_id(),customer, "ZeroBalance", initialBalance);
                break;
            default:
    ...
    private static void getBalanceMenu(IBankServiceProvider bankServiceProvider, Scanner scanner) {
        ...
        try
        {
        	double balance = bankService.getBalance(account_id);
    ...
    private static void transferMenu(IBankServiceProvider bankServiceProvider, Scanner scanner) {
        ...
        catch (InvalidAccountException | InsufficientFundException e) {
			// TODO Auto-generated catch block
        	System.out.println("Transfer Failed");
		}
    }
